...
```
<script src="https://cdn.neo4jlabs.com/neovis.js/v1.2.0/neovis.js"></script>
```

*Version without neo4j-driver dependency*

```
<script src="https://cdn.neo4jlabs.com/neovis.js/v1.2.0/neovis-without-dependencies.js"></script>
```
